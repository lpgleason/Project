...
new$list <- ifelse(grepl("10-day", new$Clean, ignore.case = T), "10-day", ifelse(grepl("60-day", new$Clean, ignore.case = T), "60-day", ifelse(grepl("7-day", new$Clean, ignore.case = T), "7-day", ifelse(grepl("15-day", new$Clean, ignore.case = T), "25-day", "Other"))))
